...
-- Return true if p is true for some v in s, otherwise else false
-- set_exists: (p: a -> bool) -> (s: set a) -> bool
set_exists p (mkSet l) = ite (member true (map p (l))) true false
...
list_witness p (h::nil) = ite (p h) (some h) none
list_witness p (h::t) = ite (p h) (some h) (list_witness p t)
--list_witness p (h::t::nil) = ite (member true (map p (h::t::nil))) (some (eql true (h::t)))
--list_witness p (h::t) = ite (member true (map p (h::t))) () (none)
--list_witness p v = ite (member true (p v)) (some v) (none)
...
-- sets {1, 2} and {a, b} is { (1, a), (1, b), (2, a), (2, b) }.
-- set_product: (s1: set a) -> (s2: set b) -> set (pair a b)
pair_elts: a -> list b -> list (pair a b)
pair_elts h nil = nil
pair_elts h (h2::t) = ((mkPair h h2)::(pair_elts h t))

pair_list: list a -> list b -> list (pair a b)
pair_list nil _ = nil
pair_list (h::t) l2 = (pair_elts h l2) ++ (pair_list t l2)
...
set_toString (mkSet h) = "{" ++ (toStringList h) ++ "}"
-------------------------------------
